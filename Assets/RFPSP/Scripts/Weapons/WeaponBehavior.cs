...
public class WeaponBehavior : MonoBehaviour {
	...
	void HitObject ( RaycastHit hit, Vector3 directionArg, bool isSecondCast = false ){
		...
		//UnityEngine.Debug.Log ("HIt object and its name " + hit.collider.gameObject.name + " tag  " + hit.collider.gameObject.tag + "layer " + hit.collider.gameObject.layer);
		...
		//checkPoint
		if (hit.collider.gameObject.tag.Equals ("lung") || hit.collider.gameObject.tag.Equals ("heart") || hit.collider.gameObject.tag.Equals ("head") || hit.collider.gameObject.tag.Equals ("body")) {

			GameObject Blood=Instantiate (BloodPrefab, hit.point, Quaternion.identity);
			Destroy (Blood, 1f);

			if (hit.collider.gameObject.transform.parent.gameObject.layer == 31) {
					
				if (hit.collider.gameObject.tag.Equals ("lung") || hit.collider.gameObject.tag.Equals ("heart")) {
					hit.collider.gameObject.GetComponent<EnableBoxCollider> ().parent.GetComponent<DinoCarnAi> ().isFiredAt = true;
					//UnityEngine.Debug.Log ("heart/lung detect");
				} else {
					hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoCarnAi> ().isFiredAt = true;//head shot body shot
				}

				//print ("dino carn ai is fired at true collider name " + hit.collider.name);

				if (hit.collider.gameObject.tag.Equals ("lung") || hit.collider.gameObject.tag.Equals ("heart") || hit.collider.gameObject.tag.Equals ("head")) {
					if (hit.collider.gameObject.tag.Equals ("head")) {
						if (!hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoCarnAi> ().headShot) {
							GameObject lm = GameObject.FindGameObjectWithTag ("LM");
							lm.GetComponent<LevelManager> ().headShot += 1;
							hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoCarnAi> ().headShot = true;
						}
					}

					if (hit.collider.gameObject.tag.Equals ("heart")) {
						if (!hit.collider.gameObject.GetComponent<EnableBoxCollider> ().parent.GetComponent<DinoCarnAi> ().heartShot) {
							GameObject lm = GameObject.FindGameObjectWithTag ("LM");
							lm.GetComponent<LevelManager> ().heartShot += 1;
							hit.collider.gameObject.GetComponent<EnableBoxCollider> ().parent.GetComponent<DinoCarnAi> ().heartShot = true;
						}
					}

					if (hit.collider.gameObject.tag.Equals ("lung")) {
						if (!hit.collider.gameObject.GetComponent<EnableBoxCollider> ().parent.GetComponent<DinoCarnAi> ().lungShot) {

							GameObject lm = GameObject.FindGameObjectWithTag ("LM");
							lm.GetComponent<LevelManager> ().lungShot += 1;
							hit.collider.gameObject.GetComponent<EnableBoxCollider> ().parent.GetComponent<DinoCarnAi> ().lungShot = true;
						}
					}

					if (hit.collider.gameObject.tag.Equals ("lung") || hit.collider.gameObject.tag.Equals ("heart")) {
						hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoCarnAi> ().TakeDamage (110);
					} else {
						hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoCarnAi> ().TakeDamage (110);
					}
				}
				if(hit.collider.gameObject.tag.Equals ("body")) {
					hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoCarnAi> ().TakeDamage (30);
				}
			}
			if (hit.collider.gameObject.transform.parent.gameObject.layer == 30) {

				if (hit.collider.gameObject.tag.Equals ("lung") || hit.collider.gameObject.tag.Equals ("heart")) {
					if (hit.collider.gameObject.GetComponent<EnableBoxCollider> ().parent.GetComponent<DinoAI> ()) {
						hit.collider.gameObject.GetComponent<EnableBoxCollider> ().parent.GetComponent<DinoAI> ().isFiredAt = true;
						//print ("dino ai is fired at true");
					} else if (hit.collider.gameObject.GetComponent<EnableBoxCollider> ().parent.GetComponent<DinoZAI> ()) {
						hit.collider.gameObject.GetComponent<EnableBoxCollider> ().parent.GetComponent<DinoZAI> ().isFiredAt = true;
						//print ("dino z ai is fired at true");
					} else {
						hit.collider.gameObject.GetComponent<EnableBoxCollider> ().parent.GetComponent<DnoZAiBron> ().isFiredAt = true;
						//print ("dino z ai bron is fired at true");
					}
				} else {
					if (hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoAI> ()) {
						hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoAI> ().isFiredAt = true;
						print ("dino ai is fired at true");
					} else if (hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DinoZAI> ()) {
						hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DinoZAI> ().isFiredAt = true;
						print ("dino z ai is fired at true");
					} else {
						hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DnoZAiBron> ().isFiredAt = true;
						print ("dino z ai bron is fired at true");
					}
				}
				...
				if (hit.collider.gameObject.tag.Equals ("lung") || hit.collider.gameObject.tag.Equals ("heart") || hit.collider.gameObject.tag.Equals ("head")) {
					if (hit.collider.gameObject.tag.Equals ("head")) {
						if (hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoAI> ()) {
							if (!hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoAI> ().headShot) {
								GameObject lm = GameObject.FindGameObjectWithTag ("LM");
								lm.GetComponent<LevelManager> ().headShot += 1;
								hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoAI> ().headShot = true;
							}
						} else if (hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DinoZAI> ()) {
							if (!hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DinoZAI> ().headShot) {
								GameObject lm = GameObject.FindGameObjectWithTag ("LM");
								lm.GetComponent<LevelManager> ().headShot += 1;
								hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DinoZAI> ().headShot = true;
							}
						} else {
							if (!hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DnoZAiBron> ().headShot) {
								GameObject lm = GameObject.FindGameObjectWithTag ("LM");
								lm.GetComponent<LevelManager> ().headShot += 1;
								hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DnoZAiBron> ().headShot = true;
							}
						}
					}
					...
					if (hit.collider.gameObject.tag.Equals ("lung")) {
						if (hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoAI>()) {
							if (!hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoAI>().lungShot) {
								GameObject lm = GameObject.FindGameObjectWithTag ("LM");
								lm.GetComponent<LevelManager> ().lungShot += 1;
								hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoAI>().lungShot = true;
							}
						} else if (hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoZAI>()) {
							if (!hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoZAI> ().lungShot) {
								GameObject lm = GameObject.FindGameObjectWithTag ("LM");
								lm.GetComponent<LevelManager> ().lungShot += 1;
								hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoZAI> ().lungShot = true;
							}
						} else {
							if (!hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DnoZAiBron> ().lungShot) {
								GameObject lm = GameObject.FindGameObjectWithTag ("LM");
								lm.GetComponent<LevelManager> ().lungShot += 1;
								hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DnoZAiBron> ().lungShot = true;
							}
						}
					}
					...
					if (hit.collider.gameObject.tag.Equals ("heart")) {
						if (hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoAI> ()) {
							if (!hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoAI> ().heartShot) {
								GameObject lm = GameObject.FindGameObjectWithTag ("LM");
								lm.GetComponent<LevelManager> ().heartShot += 1;
								hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoAI> ().heartShot = true;
							}
						} else if (hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoZAI> ()) {
							if (!hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoZAI> ().heartShot) {
								GameObject lm = GameObject.FindGameObjectWithTag ("LM");
								lm.GetComponent<LevelManager> ().heartShot += 1;
								hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoZAI> ().heartShot = true;
							}
						} else {
							if (!hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DnoZAiBron> ().heartShot) {
								GameObject lm = GameObject.FindGameObjectWithTag ("LM");
								lm.GetComponent<LevelManager> ().heartShot += 1;
								hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DnoZAiBron> ().heartShot = true;
							}
						}
					}
					...
					if (hit.collider.gameObject.tag.Equals ("lung") || hit.collider.gameObject.tag.Equals ("heart")) {
						if (hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoAI> ()) {
							hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoAI> ().TakeDamage (110);
						} else if (hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoZAI> ()) {
							hit.collider.gameObject.GetComponent<EnableBoxCollider>().parent.GetComponent<DinoZAI> ().TakeDamage (110);
						} else {
							hit.collider.gameObject.GetComponent<EnableBoxCollider>().GetComponent<DnoZAiBron> ().TakeDamage (110);
						}
					} else {
						if (hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoAI> ()) {
							hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoAI> ().TakeDamage (110);
						} else if (hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DinoZAI> ()) {
							hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DinoZAI> ().TakeDamage (110);
						} else {
							hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DnoZAiBron> ().TakeDamage (110);
						}
					}
				}
				...
				if (hit.collider.gameObject.tag.Equals ("body")) {
					if (hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoAI> ()) {
						hit.collider.gameObject.transform.parent.gameObject.GetComponent<DinoAI> ().TakeDamage (30);
					} else if (hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DinoZAI> ()) {
						hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DinoZAI> ().TakeDamage (30);
					} else {
						hit.collider.gameObject.transform.parent.gameObject.transform.parent.gameObject.GetComponent<DnoZAiBron> ().TakeDamage (30);
					}
				}
			}
		}
